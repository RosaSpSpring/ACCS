...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		circleThickness = typedArray.getDimension( R.styleable.RoundProgressBar_circleThickness, PixeUtils.dip2px( context, 4 ) );
		...
		secondTextSize = typedArray.getDimension( R.styleable.RoundProgressBar_secondTextSize, PixeUtils.sp2px( context, 16 ) );
	...
	private void drawText(Canvas canvas) {
		...
		canvas.drawText( String.valueOf( currentProgress ), center - textWidth2 / 2-textWidth3/2, center + secondTextSize / 3, paint ); //画出卡路里数值
		...
		if (thirdText != null) {
			...
			canvas.drawText( thirdText, center+textWidth2/2-textWidth3/2, center + secondTextSize / 3, paint ); //画出卡路里单位
		}
	...
	private void setAnimation(double start, double end) {
		...
		progressAnimator.addUpdateListener( new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				currentProgress = bd.setScale( 1, BigDecimal.ROUND_HALF_UP ).intValue();
